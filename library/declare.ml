...
let fixpoint_message indexes l =
  Flags.unless_quiet Feedback.msg_info (match l with
...
let definition_message id =
  Flags.unless_quiet Feedback.msg_info (pr_id id ++ str " is defined")

let assumption_message id =
  (* Changing "assumed" to "declared", "assuming" referring more to
  the type of the object than to the name of the object (see
  discussion on coqdev: "Chapter 4 of the Reference Manual", 8/10/2015) *)
  Flags.unless_quiet Feedback.msg_info (pr_id id ++ str " is declared")
