...
*)
let revert_graph kn post_tac hid gl =
...
let revert_graph kn post_tac = revert_graph kn post_tac %> Proofview.Goal.enter
...
let functional_inversion kn hid fconst f_correct gl =
...
let functional_inversion kn hid fconst =
  functional_inversion kn hid fconst %> Proofview.Goal.enter
